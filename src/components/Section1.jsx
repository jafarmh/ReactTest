    ...
    render() { 
        ...
        <React.Fragment>
            <div className="row sect">
                <div className="col-3">
                    <img className="img1" src=" https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/63c879e3c7f539bae7d030dd37904c70.svg"></img>
                </div>
                <div className="col-9 ims">
                    <div className="cons">
                    <h1 className="st">
                    ...
                    <input placeholder="Enter delivery address" className="inp-in" type="text"></input>
                        </div>
                    
                    <button className="inp-btn">Find Food</button>
                    </div>
